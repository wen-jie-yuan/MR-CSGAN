...
model_path = './saved_model/mse/10.pth'
...
parser.add_argument('--dir', type=str, default='./res_images/ps', help='save reconstruct images')
parser.add_argument('--data_test', type=str, default='Set5+Set11+Set14', help='test dataset name')
